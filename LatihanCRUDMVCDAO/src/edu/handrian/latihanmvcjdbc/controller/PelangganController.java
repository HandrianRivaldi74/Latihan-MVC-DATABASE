 ...
 */
package edu.handrian.latihanmvcjdbc.controller;

import edu.handrian.latihanmvcjdbc.model.PelangganModel;
import edu.handrian.latihanmvcjdbc.view.PelangganView;
         ...
         String alamat = view.getTxtAlamat().getText();
          String telepon = view.getTxtTelepon().getText();
           ...
           if (nama.trim().equals("")){
               ...
               JOptionPane.showMessageDialog(view, "Nama tidak boleh lebih dari 12 digit");
